...
__global__ void calculate_s1_preparation(fingerprint* fp, unsigned char* orientations, unsigned char* coherences, float* g_s, float* g_cos, float* g_sin, int count) {
    ...
    int save_idx = i/36+local_i*count;
...
// nvcc -o parallel_indexing_diffstructure_v3 parallel_indexing_diffstructure_v3.cu fingerprint_structure.cpp -std=c++11 -lineinfo
